...
var MessagebarAttachment = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  var onClick = function onClick(event) {
    (0, _utils.emit)(props, 'attachmentClick', event);
  };

  var onDeleteClick = function onDeleteClick(event) {
    (0, _utils.emit)(props, 'attachmentDelete', event);
  };
  ...
  var classes = (0, _utils.classNames)(className, 'messagebar-attachment', (0, _mixins.colorClasses)(props));
...
var _default = MessagebarAttachment;
