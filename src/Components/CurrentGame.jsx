		...
		<Container>
			...
			<Teams>
				<ScoreContainer>
					...
					<Score> current price {gameInfos.CurrentPrice} USD</Score>
					<Score> prize pool {parseFloat(gameInfos.Pool0Amount)+parseFloat(gameInfos.Pool1Amount)} MATIC</Score>
					<Score style={gameInfos.CurrentPrice > gameInfos.priceStart ? {color:"green"} : {color:"red"}}> {gameInfos.State}</Score>
