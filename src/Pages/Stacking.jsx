				...
				<ContainerGen>
					<Container>
						<StatsContainer>
							<Stats>
								<Key>Stack</Key>
								<Value>1000 0bToken</Value>
								<Button flat color="success" style={{"margin-left": "0%", "margin-top": "0%"}}>Add tokens</Button>
								<Button flat color="error" style={{"margin-left": "0%", "margin-top": "0%"}}>Remove tokens</Button>
							</Stats>
							<Stats>
								<Key>Dividend</Key>
								<Value>{profileInfos.rounds}00000000 MATIC</Value>
								<Button flat color="success" style={{"margin-left": "0%", "margin-top": "0%"}}>Collect</Button>
							</Stats>
						</StatsContainer>
					</Container>
				</ContainerGen>
